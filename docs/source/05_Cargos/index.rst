...
Dos cargos em comissão existentes na administração pública federal direta, autárquica e fundacional, no mínimo 60% (sessenta por cento) do total serão ocupados por servidores de carreira (inc. III do art. 13 da Lei nº 14.204, de 2021).
...
Considerando o disposto no inc. V do art. 37 da Constituição Federal, **as funções de confiança não podem ser ocupadas por pessoas que não ocupam cargo efetivo, nem por empregados públicos e nem por militares, sejam da ativa ou da reserva**.
...
Principais grupos de cargos em comissão e funções de confiança
--------------------------------------------------------------

Principais grupos de cargos em comissão e funções de confiança existentes no Poder Executivo federal, sem característica de exclusividade para determinados órgãos ou entidades, são os seguintes:

	I. Cargos Comissionados Executivos (CCE) e Funções Comissionadas Executivas FCE) (Lei nº 14.204, de 16 de setembro de 2021);

	II. Funções Gratificadas – FG, (art. 26 da Lei nº 8.216, de 13 de agosto de 1991).
