...
++++++++++++++++++++++++++++
É a pessoa jurídica de direito público, criada por lei específica, para prestar serviço público ou executar outra atividade administrativa que implique poderes próprios de Estado.
...
Na :numref:`ADM-direta-indireta` há uma visualização **idealizada** dos tipos institucionais correlacionados com suas funções, seus tipos de atividade e suas áreas de atuação.
...
A :numref:`Parcerias-label` apresenta alguns instrumentos de parceria entre o governo federal e entidades da sociedade civil.
